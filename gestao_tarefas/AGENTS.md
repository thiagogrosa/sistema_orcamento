...
| `scripts/bootstrap/criar_template_guia.py` | Script para criar tarefa template no Asana | Completo |
| `scripts/legacy/criar_orcamento_exemplo_subtarefas.py` | Script de exemplo com subtarefas | Completo |
...
| `data/gmail/extracted/` | Emails baixados organizados por demanda | Em uso |
| `docs/operations/gemini/GEMINI.md` | Contexto e 50+ tarefas de pesquisa mapeadas | Em uso |
| `docs/operations/gemini/GEMINI_INSTRUCOES.md` | Instrucoes detalhadas para extracao | Em uso |
| `docs/operations/gemini/pesquisa_gmail_pendentes.md` | Lista completa de demandas pendentes | Em uso |
| `data/gmail/fila_pesquisa.json` | Sistema de fila e priorizacao | Em uso |
| `data/gmail/resultados_pesquisa_gmail.json` | Resultados estruturados das buscas | Em uso |
...
python scripts/ops/processar_demandas.py --id 26_049      # Uma demanda
python scripts/ops/processar_demandas.py --prioridade alta # Por prioridade
python scripts/ops/processar_demandas.py --dry-run         # Simular
python scripts/ops/atualizar_asana.py                      # Gerar plano Asana
```
...
- [ ] Executar plano de atualizacao no Asana via MCP (data/reports/plano_atualizacao_asana.json)
...
gemini-tasks/
  ...
  └── scripts/ops/executar_pesquisa_gemini.sh   # Script auxiliar
```
