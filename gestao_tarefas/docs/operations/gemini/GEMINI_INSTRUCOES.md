...
`/root/thiagorosa/gestao-orcamentos/docs/operations/gemini/pesquisa_gmail_pendentes.md`

Salvar resultados em:
`/root/thiagorosa/gestao-orcamentos/data/gmail/resultados_pesquisa_gmail.json`
